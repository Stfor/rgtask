...
public class PicturesVO extends BaseVO implements Serializable {
    ...
    @ApiModelProperty(value = "照片id", example = "sadasd", required = true)
    private String id;
    ...
    @ApiModelProperty(value = "区域id", example = "asdsad", required = true)
    ...
    @ApiModelProperty(value = "图片信息", example = "asdasd", required = true)
