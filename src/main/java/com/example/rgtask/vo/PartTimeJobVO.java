...
public class PartTimeJobVO extends BaseVO implements Serializable {
    ...
    @ApiModelProperty(value = "兼职任务id", example = "1812312", required = true)
    private String id;
    ...
    @ApiModelProperty(value = "兼职标题", example = "1812312", required = true)
    ...
    @ApiModelProperty(value = "兼职内容", example = "1812312", required = true)
     ...
     * 兼职开始日期
     */
    @ApiModelProperty(value = "兼职开始日期", example = "1812312", required = true)
    private LocalDateTime startTime;

    /**
     * 兼职结束日期
     */
    @ApiModelProperty(value = "兼职结束日期", example = "1812312", required = true)
    private LocalDateTime endTime;

    /**
     * 工作地点
     */
    @ApiModelProperty(value = "工作地点", example = "1812312", required = true)
    private String workPlace;

    /**
     * 工作要求
     */
    @ApiModelProperty(value = "工作要求", example = "1812312", required = true)
